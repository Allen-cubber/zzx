...
### 1. 与 (AND)
*   **逻辑关系**：当所有的条件都满足时，事件才会发生，即“**<font color="orange">缺一不可</font>**”。（类似开关串联，“0”起决定性作用）
*   **公式**：$$ \boxed{Y = A \cdot B} $$

### 2. 或 (OR)
*   **逻辑关系**：当其中一个条件满足时，事件就会发生，即“**<font color="orange">有一即可</font>**”。（类似开关并联，“1”起决定性作用）
*   **公式**：$$ \boxed{Y = A + B} $$
...
## 2.6 逻辑函数的化简 ✂️
### 无关项的概念
* 逻辑函数中取值恒为0的最小项，称为**约束项**。
* 取值可以为1也可以为0的最小项，称为**任音项**。
* 约束项和任意项统称为逻辑函数式中的**无关项**，即可以写入式中，也可以不 写入式中。
