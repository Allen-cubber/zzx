...
| **方法名称**                                         | **适用调制**                                | **核心原理**                                                                                | **相位模糊**                             | **优点**                                                          | **缺点**                                                           |
| ------------------------------------------------ | --------------------------------------- | --------------------------------------------------------------------------------------- | ------------------------------------ | --------------------------------------------------------------- | ---------------------------------------------------------------- |
| **平方环法**<br><br>  <br><br>(Squaring Loop)        | **2PSK (BPSK)**<br><br>  <br><br>DSB-SC | 利用非线性变换（平方）去掉调制信息。<br><br>  <br><br>$(\pm 1)^2 = 1$，产生 $2f_c$ 的离散谱线，用 PLL 锁定后二分频。       | **有**<br><br>  <br><br>($0, \pi$)    | 结构简单，经典的模拟电路实现方案。                                               | 需要带通滤波器提取 $2f_c$，难集成；<br><br>  <br><br>无法直接用于 QPSK 或更高阶调制。       |
| **科斯塔斯环**<br><br>  <br><br>(Costas Loop)         | **2PSK, QPSK**<br><br>  <br><br>DSB-SC  | **同相(I)与正交(Q)支路相乘**产生误差电压。<br><br>  <br><br>利用误差信号控制 VCO，使 Q 支路输出趋于 0。                  | **有**<br><br>  <br><br>($2\pi/M$)    | **全基带处理**，无需提取高频倍频分量，非常适合**数字集成电路**实现。                          | 环路增益随输入信号幅度变化；<br><br>  <br><br>硬件复杂度高于平方环（双支路）。                 |
| **M 次方环**<br><br>  <br><br>(M-th Power Loop)     | **MPSK**<br><br>  <br><br>(M > 2)       | 平方环的推广。<br><br>  <br><br>通过 $M$ 次方运算去除 $2\pi/M$ 的相位调制信息，提取 $Mf_c$。                      | **有**<br><br>  <br><br>($M$ 个模糊点)    | 理论上可用于任意 MPSK。                                                  | **噪声放大效应严重**。<br><br>  <br><br>信号做 $M$ 次方，噪声也做 $M$ 次方，导致信噪比急剧恶化。 |
