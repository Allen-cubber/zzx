...
![](content/notes/数字通信原理/4.第五章数字基带信号传输/Pastedimage20251025150936.png)
...
![](content/notes/数字通信原理/4.第五章数字基带信号传输/Pastedimage20251025151033.png)
在实际系统中，最常用的是基于**脉冲幅度调制**的二进制基带信号。

### 2. 常用二进制码型 📈

不同的编码方式（码型）会赋予信号不同的特性，以适应不同的传输需求。
![](content/notes/数字通信原理/4.第五章数字基带信号传输/Pastedimage20251025151116.png)
...
- ![](content/notes/数字通信原理/4.第五章数字基带信号传输/Pastedimage20251025151224.png)
